...
namespace NeoPocketUpdater
{
    ...
    class DadoImportacaoRoteiro {
        ...
        public static void RotinaImportacao() {
            DadoImportacao.caminhoXml = D.AplicacaoDiretorio + D.TabelasXmlDiretorio;
            ...
            d = new DadoImportacao("motivo", "TB_Motivo.xml", "MOTIVO");
            d.XMLSchemaSemiAutoCarga(@"//DocumentElement/MOTIVO");
            ...
            d = new DadoImportacao("recusa", "TB_Recusa.xml", "RECUSA");
            d.XMLSchemaSemiAutoCarga(@"//DocumentElement/RECUSA");

            d.laT("id_recusa", "CODIGO");
            d.laT("id_cliente", "COD_CLIENTE");
            d.laT("id_funcionario", "COD_VENDEDOR");
            d.laD("data_visita", "DATA_VISITA");
            d.laT("id_motivo", "COD_MOTIVO");
            d.laT("observacao", "OBSERVACAO");
            d.Executar();
        }
    }
